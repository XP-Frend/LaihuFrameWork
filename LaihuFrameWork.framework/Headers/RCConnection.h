...
typedef enum{
    RCConnectionRejectStateCancel = 0,
    RCConnectionRejectStateRejecte,
    RCConnectionRejectStateDeclined,
    RCConnectionRejectStateSystemCall,
    RCConnectionRejectStateNetWorkChange,
    RCConnectionRejectStateFaild
} RCConnectionRejectState;
 ...
 */
@property (nonatomic) RCConnectionState state;
...
- (void)disconnectWithNetWorkChange;

- (void)hold;

- (void)unhold;

- (NSInteger)getNowCallStats;
 ...
 */
- (void)sendDigits:(NSString*)digits WithType:(SendDTMFType)type;
